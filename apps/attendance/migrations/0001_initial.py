    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(choices=[('NONE', 'None'), ('CONVEYANCE', 'Conveyance'), ('EXTERNALTOUR', 'External Tour'), ('SITEVISIT', 'Site Visit'), ('TRACKING', 'Tracking')], default='NONE', max_length=55)),
            ],
            options={
                'db_table': 'tracking',
            },
