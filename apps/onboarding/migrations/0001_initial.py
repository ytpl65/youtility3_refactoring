    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bu_preferences', models.JSONField(blank=True, default=apps.onboarding.models.bu_defaults, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='bu_preferences')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geofence', django.contrib.gis.db.models.fields.PolygonField(geography=True, srid=4326, verbose_name='GeoFence')),
                ('enable', models.BooleanField(default=True, verbose_name='Enable')),
            ],
            options={
