    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(choices=[('TASK', 'Task'), ('TICKET', 'Ticket'), ('TOUR', 'Tour'), ('PPM', 'PPM'), ('OTHER', 'Other')], max_length=100, null=True, verbose_name='Job Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seqno', models.SmallIntegerField(default=1, verbose_name='Seq No.')),
