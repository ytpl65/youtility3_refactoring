...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='People',
            fields=[
                ('peopleid', models.BigAutoField(auto_created=True, editable=False, primary_key=True, serialize=False, verbose_name='peopleid')),
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=15, verbose_name='gender')),
        ...
        migrations.CreateModel(
            name='Pgroup',
            fields=[
                ('groupid', models.BigAutoField(auto_created=True, editable=False, primary_key=True, serialize=False, verbose_name='groupid')),
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
        ...
        migrations.CreateModel(
            name='Pgbelonging',
            fields=[
                ('pgbid', models.BigAutoField(auto_created=True, editable=False, primary_key=True, serialize=False)),
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
        ...
        migrations.CreateModel(
            name='PeopleEventlog',
            fields=[
                ('pelogid', models.BigAutoField(auto_created=True, editable=False, primary_key=True, serialize=False, verbose_name='pelogid')),
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
        ...
        migrations.CreateModel(
            name='Capability',
            fields=[
                ('capsid', models.AutoField(auto_created=True, editable=False, primary_key=True, serialize=False)),
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
