    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_verified', models.BooleanField(default=False, verbose_name='Is Active')),
                ...
                ('buid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='people_buids', to='onboarding.bt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enable', models.BooleanField(default=True, verbose_name='Enable')),
                ('buid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgroup_buids', to='onboarding.bt')),
                ('clientid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgroup_clientids', to='onboarding.bt')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgbelonging_sites', to='onboarding.bt')),
                ('clientid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgbelonging_clients', to='onboarding.bt')),
                ...
                ('groupid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgbelongs_grps', to='peoples.pgroup')),
                ...
                ('peopleid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgbelongs_peoples', to=settings.AUTH_USER_MODEL)),
                ('tenant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tenants.tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enable', models.BooleanField(default=True, verbose_name='Enable')),
                ('clientid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='onboarding.bt')),
