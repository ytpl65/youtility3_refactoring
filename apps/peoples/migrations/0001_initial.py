    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('siteid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgroup_siteids', to='onboarding.bt')),
                ('tenant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tenants.tenant')),
            ],
            options={
                'db_table': 'pgroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('siteid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pgbelonging_sites', to='onboarding.bt')),
                ('tenant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tenants.tenant')),
            ],
            options={
