    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peopleimg', models.ImageField(blank=True, default='master/people/default.png', null=True, upload_to=apps.peoples.utils.upload_peopleimg, verbose_name='peopleimg')),
                ('peopleid', models.BigIntegerField(primary_key=True, serialize=False, verbose_name='peopleid')),
                ...
                ('loginid', models.CharField(max_length=50, unique=True, verbose_name='loginid')),
                ...
                ('mobno', models.CharField(max_length=13, verbose_name='mobno')),
                ...
                ('cuser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='created_by', to=settings.AUTH_USER_MODEL)),
                ...
                ('muser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='modified_by', to=settings.AUTH_USER_MODEL)),
                ...
                ('reportto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='people_reportto', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
                ('groupid', models.BigIntegerField(primary_key=True, serialize=False, verbose_name='groupid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
                ('pgbid', models.BigIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
                ('pelogid', models.BigIntegerField(primary_key=True, serialize=False, verbose_name='pelogid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cdtz', models.DateTimeField(auto_now_add=True, verbose_name='cdtz')),
                ('mdtz', models.DateTimeField(auto_now=True, verbose_name='mdtz')),
                ('capsid', models.BigAutoField(primary_key=True, serialize=False)),
                ('caps', models.CharField(max_length=50, verbose_name='caps')),
                ('includes', models.CharField(blank=True, default=None, max_length=1000, null=True, verbose_name='includes')),
                ('description', models.CharField(default='', max_length=200, verbose_name='description')),
                ('enable', models.BooleanField(default=True, verbose_name='enable')),
                ('cfor', models.CharField(choices=[('W', 'WEB'), ('P', 'PORTLET'), ('R', 'REPORT'), ('M', 'MOB')], default='WEB', max_length=10, verbose_name='cfor')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('caps', 'cfor'), name='capability_caps_cfor_uk'),
        ),
        migrations.AddConstraint(
            model_name='people',
