...
from apps.reports.views import (
    ConfigSiteReportTemplate, IncidentReportTemplate, MasterReportBelonging, RetriveSiteReports, SiteReportTemplate,
    SiteReportTemplateForm, IncidentReportTemplateForm) 

app_name='reports'
urlpatterns = [
    path('sitereport_list/',           RetriveSiteReports.as_view(),         name='sitereport_list'),
    path('sitereport_temp_list/',      ConfigSiteReportTemplate.as_view(),   name='config_sitereport_template'),
