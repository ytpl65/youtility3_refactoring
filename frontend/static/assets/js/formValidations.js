                ...
                validators:{
                    ...
                    callback:{
                        ...
                        callback:function(input){
                            var type = document.getElementById("id_answertype").value;
                            if(type == 'NUMERIC'){
    ...
    var qsetbng_form_validator = FormValidation.formValidation(
        document.getElementById("qsetbng_form"), qsetbngformConfig

    )

    delete qsetbngformConfig.fields.min.validators.notEmpty
    delete qsetbngformConfig.fields.max.validators.notEmpty

    var quesValidator = FormValidation.formValidation(
        document.getElementById("qsetbng_form"), qsetbngformConfig
    )
