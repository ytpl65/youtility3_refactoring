...
(function ($) {
  ...
  function jqCron(settings) {
    ...
    this.init = function () {
      ...
      if ("disable" in settings && !settings.disabled)
        settings.disabled = settings.disable;

      if (!("hour_labels" in settings))
        settings.hour_labels = settings.hours.map(function (x) {
          return String(x);
        });
      if (!("minute_labels" in settings))
        settings.minute_labels = settings.minutes.map(function (x) {
          return String(x);
        });
      if (!("monthday_labels" in settings))
        settings.monthday_labels = settings.monthdays.map(function (x) {
          return String(x);
        });
      ...
      for (
        i = 0, list = settings.hours, labelsList = settings.hour_labels;
        i < list.length;
        i++
      ) {
      ...
      for (
        i = 0, list = settings.minutes, labelsList = settings.minute_labels;
        i < list.length;
        i++
      ) {
      ...
      for (
        i = 0, list = settings.monthdays, labelsList = settings.monthday_labels;
        i < list.length;
        i++
      ) {
